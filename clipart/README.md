...
- [x] **Текстовый CTA** — произвольный текст с шрифтом, цветом, размером, обводкой, фоном
- [x] **Предустановленные позиции** — 9 пресетов (углы, стороны, центр, нижняя треть)
- [x] **Копирование элементов** — Ctrl+C / Ctrl+V с автосдвигом позиции

### Что нового в v1.1.0

- [x] **Текстовый CTA** — ввод произвольного текста с выбором шрифта, цвета, размера, обводкой и фоном
- [x] **Предустановленные позиции** — кнопки быстрого расположения (углы, центр, нижняя треть)
- [x] **Копирование элементов** — Ctrl+C / Ctrl+V для дублирования элементов
...
- **Текстовый CTA** — произвольный текст с выбором шрифта, размера, цвета, обводкой и фоном
...
- **Предустановленные позиции** — кнопки быстрого расположения (↖ ↑ ↗ ← ⊙ → ↙ ↓⅓ ↘)
- **Копирование элементов** — Ctrl+C / Ctrl+V для дублирования
